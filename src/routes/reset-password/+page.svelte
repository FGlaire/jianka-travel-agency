...
<svelte:head>
  <title>Reset Password - JIANKA Travel Agency</title>
</svelte:head>
  ...
  <div class="auth-card">
    ...
    <form on:submit={handleResetPassword} class="auth-form">
      ...
      <div class="form-actions">
        <button type="submit" class="auth-button" disabled={isLoading || password !== confirmPassword}>
          {#if isLoading}
      ...
      <div class="auth-links">
        <p><a href="/login" class="login-link">Back to Login</a></p>
      </div>
    </form>
  </div>
</div>
